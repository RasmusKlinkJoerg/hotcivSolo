...
public class FractalAdapterLayoutStrategy implements LayoutStrategy {
    ...
    public void createWorld(HashMap<Position, CityImpl> cityHashMap, HashMap<Position, UnitImpl> unitHashMap, HashMap<Position, Tile> tileHashMap) {
        ...
        for (int row = 0; row < 16; row++) {
            ...
            for (int col = 0; col < 16; col++) {
                stringBuilder.append(generator.getLandscapeAt(row, col));
            }
            layout[row] = stringBuilder.toString();
        }
        // Conversion...
